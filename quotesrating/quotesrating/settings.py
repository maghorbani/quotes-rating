"""
Django settings for quotesrating project.
...
# reading value fron .env file in the project root dir
env = environ.Env()
...
ALLOWED_HOSTS = []
if env('ALLOWED_HOSTS').strip() != "":
    ALLOWED_HOSTS = [item.strip() for item in env('ALLOWED_HOSTS').split(",")]
...
WSGI_APPLICATION = 'quotesrating.wsgi.application'
